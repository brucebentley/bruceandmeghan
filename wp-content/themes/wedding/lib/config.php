...
namespace BruceBentley\Wedding\Config;

use BruceBentley\Wedding\ConditionalTagCheck;
...
function display_sidebar() {
  ...
  if (!isset($display)) {
    ...
    $display = apply_filters('wedding/display_sidebar', $conditionalCheck->result);
  }
